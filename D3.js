...
if (num5 === 8 || num6 === 8) {
  ...
  console.log(
    "nessuno dei numeri forniti è uguale ad 8, ne la loro somma/differenza è uguale ad 8"
  );
}
...
if (totalShoppingCart > 50) {
  console.log(
    "Hai diritto alla spedizione gratuita e quindi devi pagare un totale di: " +
      totalShoppingCart
  );
} else {
  newTotalShoppingCart = totalShoppingCart + 10;
  console.log(
    "la vostra spedizione costa 10$, quindi il totale da pagare è: " +
...
if (totalShoppingCart2 > 50) {
  ...
  console.log(
    "Hai diritto alla spedizione gratuita e hai uno sconto del 20% quindi il totaleè: " +
      newTotalShoppingCart2
  );
} else {
  newTotalShoppingCart2 = totalShoppingCart2 * 0.8 + 10;
  console.log(
    "la vostra spedizione costa 10$, ma hai comunque il 20% du sconto e quindi il totale da pagare è: " +
      newTotalShoppingCart2
  );
}
...
if (numero > numero1 && numero > numero2) {
  if (numero1 > numero2) {
    ...
    console.log(numero, numero2, numero1);
  }
  ...
  if (numero > numero1) {
    console.log(numero2, numero, numero1);
  } else {
    console.log(numero2, numero1, numero);
  }
}
/* ESERCIZIO 8
